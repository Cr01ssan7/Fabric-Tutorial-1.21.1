package net.xander.tutorialmod.item;
...
import net.xander.tutorialmod.item.custom.ChiselItem;
import net.xander.tutorialmod.item.custom.SmiteStick;
...
public class ModItems {
    ...
    public static final Item CHISEL = registerItem("chisel", new ChiselItem(new Item.Settings().maxDamage(300).maxCount(1)));
